...
type CustomPolicyMetaParameters struct {
...
type CustomPolicyObservation struct {
	...
	Meta []CustomPolicyMetaObservation `json:"meta,omitempty" tf:"meta,omitempty"`
	...
	Spec []CustomPolicySpecObservation `json:"spec,omitempty" tf:"spec,omitempty"`
}
...
type CustomPolicyParameters struct {
	...
	// Metadata for the resource
	// +kubebuilder:validation:Optional
	Meta []CustomPolicyMetaParameters `json:"meta,omitempty" tf:"meta,omitempty"`
	...
	// Spec for the custom policy
	// +kubebuilder:validation:Optional
	Spec []CustomPolicySpecParameters `json:"spec,omitempty" tf:"spec,omitempty"`
}
...
// CustomPolicy is the Schema for the CustomPolicys API. <no value>
